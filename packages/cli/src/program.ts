...
export function criarPrograma(io: CliIo): Command {
...
export async function executarCli(argumentos: readonly string[], io: CliIo): Promise<number> {
  return executarPrograma(criarPrograma(io), argumentos);
}
