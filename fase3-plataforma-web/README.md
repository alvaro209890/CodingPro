...
**Status:** 📋 Planejado em 2026-07-22 · aguardando fases anteriores
...
- **Servidor: este PC (acer)**, expostos via **Cloudflare Tunnel** no **domínio já comprado (`cursar.space`)** — mesmo modelo do NexoGeo (`nexogeo-api.cursar.space`).
